...
<div class="lpl-card">
    ...
    <p class="lpl-admin__subtitle"><?php echo esc_html__('Complete reference of all available shortcode options for both video and audio player.', 'vapfem'); ?></p>
    ...
    <table class="lpl-shortcode-table">
        ...
        <tbody>
            ...
            <tr class="lpl-options-table__section-header">
