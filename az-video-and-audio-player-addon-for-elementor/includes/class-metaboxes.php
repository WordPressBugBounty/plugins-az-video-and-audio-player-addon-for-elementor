    ...
    public static function get_field_definitions() {
        return [
            ...
            '_ratio' => [
                ...
                'tooltip' => __('<strong>What it does</strong><br>Reserves the player shape up front so the page does not jump while the video loads.<br><br><strong>Automatic</strong> defaults to 16:9 (most widescreen videos).<br><br><strong>Pick a shape</strong> to force it, for example <code>9:16</code> for vertical / reel-style video.', 'vapfem'),
                'tooltip_width' => 'wide',
                'options' => leanpl_get_ratio_options(),
                'group' => 'video_options',
            ],
            '_portrait_max_height' => [
                'type' => 'text',
                'label' => __('Vertical Video Max Height', 'vapfem'),
                'desc' => __('Caps how tall a 9:16 (Vertical / Reel) video is allowed to grow. Leave empty for the default (70vh).', 'vapfem'),
                'tooltip' => __('<strong>What it does</strong><br>Stops a vertical video from filling the whole page height by capping its size.<br><br>Accepts <code>px</code>, <code>%</code>, <code>vh</code>, <code>vw</code>, <code>em</code>, or <code>rem</code>, e.g. <code>70vh</code> or <code>600px</code>. Only affects players explicitly set to a vertical shape above.', 'vapfem'),
                'tooltip_width' => 'wide',
                'placeholder' => '70vh',
                'group' => 'video_options',
            ],
