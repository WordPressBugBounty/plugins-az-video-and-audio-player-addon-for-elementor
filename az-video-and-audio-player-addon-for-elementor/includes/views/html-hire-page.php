...
?>
<div class="wrap lpl-admin lpl-hire-page">
    <div class="lpl-heading-1"><?php echo esc_html__('WordPress Development Services', 'vapfem'); ?></div>

    <div class="lpl-layout--grid-sidebar">
        <div class="lpl-layout__content">
            <!-- Why Work With Me Section -->
            <div class="lpl-hire__section">
                <div class="lpl-heading-2"><?php echo esc_html__('Why Work With Me?', 'vapfem'); ?></div>

                <p class="lpl-hire__intro-text">
                ...
                <div class="lpl-hire__highlight-callout">
                    <p>"<span class="lpl-text-highlight--minimal">Alberuni is a naturally talented and super-hardworking developer.</span> I can't recommend him enough for app and web development projects. He is a pleasure to work with too. Highly recommended!"</p>
                    <cite>— Kristen M. Stanton, Marketing Consultant & Founder of UniGuide Media LLC (via LinkedIn)</cite>
                </div>
            </div>

            <hr class="lpl-section-separator">

            <!-- What Makes Me Different Section -->
            <div class="lpl-hire__section">
                <div class="lpl-heading-2"><?php echo esc_html__('What Makes Me Different', 'vapfem'); ?></div>

                <div class="lpl-features">
                    <div class="lpl-features__item">
                        <span class="lpl-features__check"></span>
            ...
            <div class="lpl-hire__section">
                <div class="lpl-heading-2"><?php echo esc_html__('How I Can Help You', 'vapfem'); ?></div>
                <p class="lpl-hire__intro-text"><?php echo esc_html__('I specialize in helping businesses, educators, and content creators with:', 'vapfem'); ?></p>
            ...
            <!-- Let's Talk Section -->
            <div class="lpl-info-block lpl-info-block--contact">
                <div class="lpl-heading-3"><?php echo esc_html__('Let\'s Talk', 'vapfem'); ?></div>
                <p>
                ...
                <div class="lpl-strategy-call lpl-margin-block--20">
                    <div class="lpl-heading-3"><?php echo esc_html__('👉 Book a Free Discovery Call', 'vapfem'); ?></div>
                ...
                <ul>
                    ...
                    <li><strong><?php echo esc_html__('Email Me', 'vapfem'); ?></strong> → <a href="mailto:helloalberuni@gmail.com"><?php echo esc_html__('helloalberuni@gmail.com', 'vapfem'); ?></a> &nbsp;&nbsp;<button class="lex-copy-button" data-lex-copy="helloalberuni@gmail.com">Copy</button></li>
        ...
        <div class="lpl-sidebar-widget">
            <div class="lpl-sidebar__widget-header">
                <div class="lpl-sidebar__widget-heading"><?php echo esc_html__('Let\'s Talk', 'vapfem'); ?></div>
                <p class="lpl-sidebar__widget-tagline"><?php echo esc_html__('Ready to discuss your project?', 'vapfem'); ?></p>
            </div>

            <div class="lpl-sidebar__widget-content">
                <div class="lpl-sidebar__widget-text">
                    <?php echo __('We’ll explore your goals, challenges, and next steps to see how I can help.', 'vapfem'); ?>
                </div>

                <a href="https://helloalberuni.com/discovery-call?utm_source=wporg&utm_medium=admin&utm_campaign=vapfem" class="lpl-primary-button" target="_blank">
                    <?php echo esc_html__('Book a Discovery Call', 'vapfem'); ?>
                </a>

                <div class="lpl-contact__methods">
                    <div class="lpl-contact__item">
                        <div class="lpl-contact__text">
                            <span class="lpl-contact__label"><?php echo esc_html__('Email Me', 'vapfem'); ?></span>
                            <a href="mailto:helloAlberuni@gmail.com" class="lpl-contact__description">helloAlberuni@gmail.com</a>
                        </div>
                        <!-- Copy email button -->
                        <button class="lex-copy-button" data-lex-copy="helloAlberuni@gmail.com">Copy</button>
                    </div>

                    <div class="lpl-contact__item">
                        <div class="lpl-contact__text">
                            <span class="lpl-contact__label"><?php echo esc_html__('View Portfolio', 'vapfem'); ?></span>
                            <a href="https://helloalberuni.com/?utm_source=wporg&utm_medium=admin&utm_campaign=vapfem" class="lpl-contact__description" target="_blank">https://helloalberuni.com</a>
                        </div>
                    </div>
                </div>

                <div class="lpl-trust-badge">
                    <div class="lpl-trust-badge__text"><?php echo esc_html__('Typical Response Time', 'vapfem'); ?></div>
                    <div class="lpl-trust-badge__value"><?php echo esc_html__('Within 24 hours', 'vapfem'); ?></div>
                </div>
            </div>
        </div>
    </div>
