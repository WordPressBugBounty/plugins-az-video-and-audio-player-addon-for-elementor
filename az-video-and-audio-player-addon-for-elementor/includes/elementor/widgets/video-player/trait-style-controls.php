...
trait LeanPL_Video_Player_Style_Controls {
    ...
    protected function register_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'   => [ '{{WRAPPER}} .plyr' => '--plyr-video-control-color: {{VALUE}};' ],
            ]
        );
        ...
        $this->add_control( 'pv_range_fill',        [ 'label' => esc_html__( 'Fill (Progress + Volume)', 'vapfem' ),   'type' => \Elementor\Controls_Manager::COLOR, 'condition' => [ 'popover_progress' => 'yes' ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-range-fill-background: {{VALUE}};' ] ] );
        $this->add_control( 'pv_progress_buffered', [ 'label' => esc_html__( 'Buffered', 'vapfem' ),                   'type' => \Elementor\Controls_Manager::COLOR, 'condition' => [ 'popover_progress' => 'yes' ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-video-progress-buffered-background: {{VALUE}};' ] ] );
        $this->add_control( 'pv_range_thumb',       [ 'label' => esc_html__( 'Handle (Progress + Volume)', 'vapfem' ), 'type' => \Elementor\Controls_Manager::COLOR, 'condition' => [ 'popover_progress' => 'yes' ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-range-thumb-background: {{VALUE}};' ] ] );
        ...
        $this->start_popover();
        $this->add_control( 'pv_tooltip_bg',    [ 'label' => esc_html__( 'Background', 'vapfem' ), 'type' => \Elementor\Controls_Manager::COLOR, 'condition' => [ 'popover_tooltips' => 'yes' ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-tooltip-background: {{VALUE}};' ] ] );
        $this->add_control( 'pv_tooltip_color', [ 'label' => esc_html__( 'Text Color', 'vapfem' ),  'type' => \Elementor\Controls_Manager::COLOR, 'condition' => [ 'popover_tooltips' => 'yes' ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-tooltip-color: {{VALUE}};' ] ] );
        $this->end_popover();
        ...
        $this->start_popover();
        $this->add_control( 'pv_menu_bg',    [ 'label' => esc_html__( 'Background', 'vapfem' ), 'type' => \Elementor\Controls_Manager::COLOR, 'condition' => [ 'popover_menu' => 'yes' ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-menu-background: {{VALUE}};' ] ] );
        $this->add_control( 'pv_menu_color', [ 'label' => esc_html__( 'Text Color', 'vapfem' ),  'type' => \Elementor\Controls_Manager::COLOR, 'condition' => [ 'popover_menu' => 'yes' ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-menu-color: {{VALUE}};' ] ] );
        $this->end_popover();
        ...
        $this->add_control( 'pv_control_icon_size', [ 'label' => esc_html__( 'Icon Size (Controls + Menu)', 'vapfem' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 10, 'max' => 40 ] ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-control-icon-size: {{SIZE}}{{UNIT}};' ] ] );
        $this->add_control(
            'pv_control_spacing',
            [
        ...
        $this->add_control( 'pv_control_radius', [ 'label' => esc_html__( 'Corner Radius', 'vapfem' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 0, 'max' => 30 ] ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-control-radius: {{SIZE}}{{UNIT}};' ] ] );
        ...
        $this->add_control( 'pv_range_track_height', [ 'label' => esc_html__( 'Track Height (Progress + Volume)', 'vapfem' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 1, 'max' => 20 ] ], 'selectors' => [ '{{WRAPPER}} .plyr' => '--plyr-range-track-height: {{SIZE}}{{UNIT}};' ] ] );
